...
| **TypeScript / TSX** | `.ts`, `.tsx`, `.mts`, `.cts` | функции, стрелочные функции, методы, сигнатуры классов, JSDoc |
| **JavaScript / JSX** | `.js`, `.jsx`, `.mjs`, `.cjs` | функции, стрелочные функции, методы, сигнатуры классов, JSDoc |
...
| **C** | `.c`, `.h` | функции, структуры, объединения, перечисления, комментарии |
| **C++** | `.cpp`, `.hpp`, `.cc`, `.cxx`, `.hh`, `.hxx` | функции, методы, классы, структуры, пространства имен |
| **Kotlin** | `.kt`, `.kts` | функции, классы, объекты, методы, KDoc |
| **Swift** | `.swift` | функции, методы, классы, структуры, протоколы, перечисления, Swift-doc |

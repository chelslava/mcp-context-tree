...
[![Tests](https://img.shields.io/badge/tests-83%20passed-success?style=flat-square&logo=pytest&logoColor=white)](https://github.com/chelslava/mcp-context-tree/actions)
...
- 🗜️ **Embedding Quantization (INT8 & Binary):** 4x to 32x RAM and storage compression with scalar/binary quantized vector representations.
- 🔌 **Language Server Protocol (LSP) Bridge:** Compiler-grade symbol definitions, hover documentation, and references across local language servers.
